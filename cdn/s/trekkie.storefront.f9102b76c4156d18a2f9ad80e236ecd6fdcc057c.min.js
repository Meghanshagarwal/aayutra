! function() {
    var e = {
            ...
            3249: function(e, t, n) {
                ...
                t.updateTrackingConsent = function(e, t) {
                    ...
                    function i(r, i) {
                        ...
                        var s;
                        0 === (s = n.status) || 200 >= s && s < 400 ? (o.dispatchEvents(e), void 0 !== t && t(null, a), r(a)) : (void 0 !== t && t(a), i({
                            response: a,
                            code: n.status
                        }))
                    }
                    return n.open("POST", "/set_tracking_consent.json", !0), n.setRequestHeader("Content-Type", "application/json"), t ? (n.onreadystatechange = () => i((e => {}), (e => {})), void n.send(r)) : new Promise(((e, t) => {
            ...
            5841: function(e, t, n) {
                ...
                function s() {
                    ...
                    if (void 0 !== e && ! function(e) {
                            ...
                            const t = Object.keys(e).filter((e => "region" !== e && "lim" !== e && "cus" !== e && "reg" !== e));
                ...
                t.CONSENT_COOKIE_NAME = a, t.getCCPAConsentValue = function() {
                    ...
                    const e = c();
                    if (!d(e) && e.cus) return Object.entries(e.cus).map((([e, t]) => ({
                    ...
                    const e = c();
                    return d(e) ? "" : e.region || ""
                }, t.getSignal = p, t.readCookieAndTransform = c, t.setStorefrontApiTrackingConsent = function(e, t) {
                    ...
                    return i.writeCookie(a, e.rootDomain, 31536e6, c), t(null), new Promise(((e, t) => {}))
            ...
            8920: function(e, t, n) {
                ...
                t.saleOfDataRegion = i.saleOfDataRegion, t.GPCSignal = l, t.doesMerchantSupportGranularConsent = function() {
                    return !0
                    ...
                    return (n.storefrontAccessToken || n.metafields || c ? s.storefrontApiUpdateTrackingConsent : a.updateTrackingConsent)({
                        granular_consent: n,
                        ...null !== r && {
                            referrer: r
                        },
                    ...
                    return console.warn("shouldShowCCPABanner is deprecated and will be removed."), i.saleOfDataRegion() && f() === o.DisplayConsentValues.NO_INTERACTION
                }, t.shouldShowGDPRBanner = function() {
                    return i.shouldShowBanner() && c() === o.DisplayConsentValues.NO_INTERACTION
            ...
            5542: function(e, t, n) {
                ...
                function c(e) {
                    ...
                    return {
                        query: `query { consentManagement { cookies(${s.objectToGraphQL(t)}) { answersCookie trackingConsentCookie cookieDomain } } }`,
                        variables: {}
                    }
                }
                t.storefrontApiUpdateTrackingConsent = function(e, t) {
                    ...
                    return fetch(`https://${u}/api/unstable/graphql.json`, d).then((e => {
                        if (e.ok) return e.json();
                        throw new Error("Server error")
                    })).then((s => {
                        const c = 31536e6,
                            u = s.data.consentManagement.cookies.cookieDomain,
                            d = "." + (n.checkoutRootDomain || u || window.location.hostname),
                            p = "." + (n.storefrontRootDomain || u || window.location.hostname),
                            l = s.data.consentManagement.cookies.trackingConsentCookie,
                            f = s.data.consentManagement.cookies.answersCookie;
                        return r.writeCookie(i.CONSENT_COOKIE_NAME, d, c, l), r.writeCookie(a.CMP_ANSWERS_COOKIE_NAME, d, c, f), p !== d && (r.writeCookie(i.CONSENT_COOKIE_NAME, p, c, l), r.writeCookie(a.CMP_ANSWERS_COOKIE_NAME, p, c, f)), o.dispatchEvents(e), void 0 !== t && t(null, s), s
                    })).catch((e => {
            ...
            6304: function(e, t) {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    ACCEPTED: "1",
                    DECLINED: "0"
                }, t.CookieKeys = ["v", "con"], t.CookieVersion = "2.1", t.DataProcessingPurpose = {
                    PREFERENCES: "p",
                    ANALYTICS: "a",
                    MARKETING: "m",
                    SALE_OF_DATA: "t"
            ...
            3653: function(e, t, n) {
                ...
                var g = function(e) {
                    ...
                    return r(n, e), n.prototype.name = function() {
                        ...
                        return y.analyticsProcessingAllowed(e) && y.marketingAllowed(e)
                        ...
                        return i(i({
                            ...
                            asset_version_id: "f9102b76c4156d18a2f9ad80e236ecd6fdcc057c",
            ...
            6997: function(e, t, n) {
                    ...
                    if (void 0 === o)
                        if (function() {
                            ...
                            for (var t = "", n = 0, r = d.hostname().split(".").reverse(); n < r.length; n++) {
                                ...
                                if (v(e, a, 0, t), g(e, a)) return void(o = t)
                            }
                            o = ""
                        }
                }
                ...
                t.parseDocumentCookie = h, t.cookieImpl = {
                    ...
                    void 0 === r && (r = "Lax"), y(e), v(e, t, n ? 31104e6 : 18e5, o, r)
                }, t.clear = function(e) {
                    y(e), v(e, "", -1, o), v(e, "", -1, "")
            ...
            2971: function(e, t, n) {
                ...
                t.metricsSchemaId = "trekkie_metrics/2.0", t.errorsSchemaId = "trekkie_errors/2.0", t.setGlobalSerializedAppConfig = function(e) {
                    ...
                    if (this.shouldSendToBugsnag()) {
                        var n = "f9102b76c4156d18a2f9ad80e236ecd6fdcc057c",
                            o = null,
                            r = null,
                            i = null;
                        if (e.appConfig) try {
            ...
            9426: function(e, t, n) {
                    ...
                    v = function() {
                        ...
                        return e.prototype.configureMonorailRegion = function(e) {
                            ...
                            a.addBatchEvent({
                                ...
                                payload: {
                                    build_id: "f9102b76c4156d18a2f9ad80e236ecd6fdcc057c",
                ...
                t.Tricorder = v, t.replayAnalyticsQueue = function(e, t) {
            ...
            803: function(e, t, n) {
                ...
                const o = "sh",
                    ...
                    y = "checkout_address_info_submitted",
                    g = "checkout_shipping_step_started",
                    v = "checkout_shipping_info_submitted",
                ...
                function P() {
                    ...
                    e.Shopify = e.Shopify || {}, e.Shopify.evids || (A = {
                        ...
                        if (!A[e] || (null == t ? void 0 : t.analyticsFramework) !== T && (null == t ? void 0 : t.analyticsFramework) !== C) return I(r);
