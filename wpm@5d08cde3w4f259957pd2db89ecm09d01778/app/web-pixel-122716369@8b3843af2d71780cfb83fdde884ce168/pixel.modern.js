(function(shopify) {
    (() => {
        ...
        function z() {
            ...
            o === void 0 ? document.head.appendChild(x()) : (b = o.parentNode) == null || b.insertBefore(x(), o)
        }
        R();
        z();
        _(({
            ...
            function k(t) {
                ...
                if (c != null) {
                    for (let e of c)
                        if (e.variant.product.id) return "product_group"
                }
                return "product"
            }
            ...
            function q(t) {
                let c = 0,
                    e = t.data.checkout.lineItems;
                if (e != null)
                    for (let n of e) c += n.quantity || 1;
                return c
            }

            function A(t, c) {
                return c == null || F.includes(c.toLowerCase()) ? t || "" : t + " - " + c
            }
            ...
            C(g), window.fbq("init", V, {}, {
                ...
                let c = t.data.productVariant.product.id || t.data.productVariant.id || t.data.productVariant.sku,
                    ...
                    i = A(t.data.productVariant.product.title, t.data.productVariant.title),
                ...
                let c = ((u = t.data.cartLine) == null ? void 0 : u.merchandise.product.id) || ((p = t.data.cartLine) == null ? void 0 : p.merchandise.id) || ((l = t.data.cartLine) == null ? void 0 : l.merchandise.sku),
                    e = c ? [parseInt(c)] : [],
                    n = (f = t.data.cartLine) != null && f.merchandise.product.id ? "product_group" : "product",
                    i = A((m = t.data.cartLine) == null ? void 0 : m.merchandise.product.title, (I = t.data.cartLine) == null ? void 0 : I.merchandise.title),
                    r = ((L = t.data.cartLine) == null ? void 0 : L.merchandise.product.type) || "",
                    d = ((P = t.data.cartLine) == null ? void 0 : P.merchandise.price.currencyCode) || "USD",
                    s = (D = t.data.cartLine) == null ? void 0 : D.merchandise.price.amount,
...
})(self.webPixelsManager.createShopifyExtend('122716369', 'app'));